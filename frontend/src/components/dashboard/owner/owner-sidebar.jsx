...
const MODULE_MAP = {
  "/dashboard/restaurante/pedidos": "pedidos",
  ...
  "/dashboard/restaurante/personalizacion": "personalizacion",
  "/dashboard/restaurante/configuracion": "configuracion",
}
...
const menuItems = [
  ...
  {
    title: "Operadores",
    href: "/dashboard/restaurante/operadores",
    icon: UserCog,
  },
  {
    title: "Mi Perfil",
...
export function OwnerSidebar({ className, onNavigate }) {
  ...
  const isOwner = user?.role === "restaurante" || user?.roles?.includes("restaurante")
