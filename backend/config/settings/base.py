...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "filename": BASE_DIR / "logs" / f"{env('DJANGO_NAME_LOG_FILE',default='django')}.log",
            "formatter": "verbose",
            "encoding": "utf-8",
        },
    },
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        "checkout_authenticated": "15/hour",
        "checkout_guest": "5/hour",
    },
}
...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "HS256",
    "SIGNING_KEY": env("DJANGO_SECRET_KEY", default="insecure-dev-signing-key"),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Documentation of API endpoints of Restaurante",
    "VERSION": "1.0.0",
